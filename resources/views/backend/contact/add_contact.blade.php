                                ...
                                <form method="POST" action="{{route('store.contact')}}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="facebook" name="facebook" value="" class="form-control" id="facebook">
                                            <font style="color: red">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="twitter" name="twitter" value="" class="form-control" id="twitter">
                                            <font style="color: red">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="youtube" name="youtube" value="" class="form-control" id="youtube">
                                            <font style="color: rgb(41, 40, 40)">
                                                {{($errors->has('youtube'))?($errors->first('youtube')):""}}
                                            </font>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="google_plus">Linkedin</label>
                                            <input type="google_plus" name="google_plus" value="" class="form-control" id="google_plus">
                                            <font style="color: rgb(41, 40, 40)">

            ...
            <div class="card">
              ...
              <div class="card-body ">
               <table id="example1" class="table table-bordered table-striped ">
                  ...
                  <tbody>
                    @foreach ($view_communication as $key => $communicate)
                        <tr>
                            <td>{{ $key+1 }}</td>
                            ...
                            <td>
                            <a title="Delete" id="delete" class="btn btn-danger btn-sm" href="{{ route('delete.communication',$communicate->id) }}"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
                    @endforeach
                   </tbody>

                ...
                <div class="row">
                    <section class="col-md-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form method="POST" action="{{route('update.logo', $edit_logo->id)}}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-2">
                                            <img id="showImage" src="{{(!empty($edit_logo->image))?url($edit_logo->image):url('backend/upload/02.png')}}" style="width: 150px; height: 160px; border: 1px solid #000;">
                                        </div>

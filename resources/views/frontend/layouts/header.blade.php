<header class="header-v4">
            ...
            <div class="content-topbar flex-sb-m h-full container">
                ...
                <div class="right-top-bar flex-w h-full">
                    <ul class="social">
                        ...
                        <li class="linkedin"><a href="{{$contact->google_plus}}"><i class="fa fa-linkedin"></i></a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="wrap-menu-desktop how-shadow1">
            <nav class="limiter-menu-desktop container">
                ...
                <a href="{{ url('') }}" class="logo">
                    <img src="{{ url('backend/upload/logo_images/1610023173.png') }}" alt="Kire image pas na k">
                </a>
    ...
    <div class="wrap-header-mobile">
        ...
        <div class="logo-mobile">
            <a href="{{url(('/'))}}"><img src="" alt="IMG-LOGO"></a>
        </div>
        ...
        <div class="header-cart-content flex-w js-pscroll">
            ...
            <div class="w-full">
                ...
                <div class="header-cart-buttons flex-w w-full">
                    ...
                    <a href="{{route('shopping.cart')}}" class="flex-c-m stext-101 cl0 size-107 bg3 bor2 hov-btn3 p-lr-15 trans-04 m-b-10">
                        Check Out
                    </a>
                </div>
            </div>
